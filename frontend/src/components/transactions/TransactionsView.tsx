...
export const TransactionsView = ({ onBack }: TransactionsViewProps) => {
  ...
  return (
    <div style={{ animation: "fsu 0.26s ease", paddingBottom: "100px" }}>
      ...
      <div className="flex items-center gap-3 mb-4 sticky top-2 z-[60] bg-[#0A1220]/70 backdrop-blur-2xl px-4 py-3.5 rounded-[28px] border border-white/[0.05] shadow-[0_8px_32px_rgba(0,0,0,0.4)] mx-2">
